...
const int BATTERY_CELLS = 2;
const float VOLTAGE_DIVIDER_R1 = (47 * 1000);    // 47 kohm
const float VOLTAGE_DIVIDER_R2 = (24.2 * 1000);  // 24.2 kohm

#if BATTERY_TYPE == BATTERY_TYPE_LI_ION
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_90 = (BATTERY_CELLS * 2.6);
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_50 = (BATTERY_CELLS * 2.2);
